...
A preprint of the paper introducing JMetalPy is available at: https://arxiv.org/abs/1903.02915. The paper has been accepted Swarm and Evolutionary Computation, in and the online version at: https://doi.org/10.1016/j.swevo.2019.100598.     
If you use the software include the citation "Benítez-Hidalgo A, Nebro AJ, García-Nieto J, Oregi I, Del Ser J. jMetalPy: A Python framework for multi-objective optimization with metaheuristics. Swarm and Evolutionary Computation, In Press, 2019".
